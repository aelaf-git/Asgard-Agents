...
export const AI_AGENTS: AgentProfile[] = [
  {
    id: 'code-auditor',
    name: 'CIPHER (Coming Soon)',
    role: 'Cyber-Security Engineer (Agentic)',
    description: 'High-performance agentic auditor. Currently offline for upgrades.',
    specialties: ['GitHub Integration', 'Smart Contract Audit', 'Vulnerability Detection'],
    priceSOL: 0.001,
    rating: 4.9,
    completedJobs: 1247,
    avatar: 'C',
